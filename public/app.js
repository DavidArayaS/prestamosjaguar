const translations = {
  es: {
    ...
    faqQ1: '¿Puedo solicitar si mi propiedad está fuera del GAM?',
    faqA1: 'Sí. Atendemos operaciones dentro y fuera del Gran Área Metropolitana en todo Costa Rica.',
  ...
  en: {
    ...
    faqQ1: 'Can I apply if my property is outside the GAM?',
    faqA1: 'Yes. We handle operations both inside and outside the Greater Metropolitan Area across Costa Rica.',
    faqQ2: 'Can I apply if I am a foreign applicant?',
  ...
  fr: {
    ...
    faqQ1: 'Puis-je demander si ma propriété est hors de la GAM ?',
    faqA1: 'Oui. Nous traitons des opérations dans et hors de la Grande Zone Métropolitaine dans tout le Costa Rica.',
    faqQ2: 'Puis-je demander un crédit en tant qu’étranger ?',
