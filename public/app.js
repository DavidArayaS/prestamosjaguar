const translations = {
  es: {
    ...
    heroMetric2Value: 'Empresas y personas nacionales o extranjeras residentes.',
    ...
    testPrevAria: 'Anterior',
    testNextAria: 'Siguiente',
    testDotsAria: 'Indicadores',
    coverageTitle: 'Préstamos hipotecarios por provincia en Costa Rica',
    coverageText:
    ...
    coverageCard3Text: 'Financiamiento con garantía de inmueble para liquidez, inversión o capital de trabajo.',
    coverageCard4Title: 'Préstamos hipotecarios en Alajuela',
    coverageCard4Text: 'Formalización clara para propiedades residenciales y comerciales en toda la provincia.',
    coverageCard5Title: 'Préstamos hipotecarios en Guanacaste',
    coverageCard5Text: 'Atendemos casos fuera del GAM con evaluación profesional y seguimiento continuo.',
    coverageCard6Title: 'Préstamos hipotecarios en Puntarenas',
    coverageCard6Text: 'Cobertura nacional para propiedades inscritas, con proceso legal y transparente.',
    coverageCard7Title: 'Préstamos hipotecarios en Limón',
    coverageCard7Text: 'Atención para propiedades en el Caribe con acompañamiento claro de inicio a formalización.',
    coverageCardCta: 'Solicitar evaluación',
    ...
    faqA2: 'Sí. Atendemos a clientes de todas las nacionalidades residentes legales dueñas de propiedades en Costa Rica.',
    faqQ3: '¿Trabajan con independientes y empresas?',
    faqA3: 'Sí. Evaluamos personas físicas, trabajadores independientes y personas jurídicas.',
  ...
  en: {
    ...
    heroMetric2Value: 'Nationals and resident foreigners',
    ...
    testPrevAria: 'Previous',
    testNextAria: 'Next',
    testDotsAria: 'Indicators',
    coverageTitle: 'Mortgage loans by province in Costa Rica',
    coverageText:
    ...
    coverageCard3Text: 'Property-backed financing for liquidity, investment or working capital.',
    coverageCard4Title: 'Mortgage loans in Alajuela',
    coverageCard4Text: 'Clear formalization for residential and commercial properties throughout the province.',
    coverageCard5Title: 'Mortgage loans in Guanacaste',
    coverageCard5Text: 'We handle cases outside the GAM with professional evaluation and continuous follow-up.',
    coverageCard6Title: 'Mortgage loans in Puntarenas',
    coverageCard6Text: 'Nationwide coverage for registered properties with a legal and transparent process.',
    coverageCard7Title: 'Mortgage loans in Limón',
    coverageCard7Text: 'Support for properties in the Caribbean region with clear guidance from start to formalization.',
    coverageCardCta: 'Request evaluation',
    faqTitle: 'Frequently asked questions',
    faqText: 'Direct answers to the most common questions before requesting your evaluation.',
    faqQ1: 'What are the requirements to apply?',
    faqA1:
      'The main requirement is to be the owner of the property used to request the loan, along with your identity card to begin the evaluation.',
    faqQ2: 'Can I apply if I am a resident foreign applicant?',
    faqA2: 'Yes. We assist clients of all nationalities who own properties in Costa Rica.',
    faqQ3: 'Do you work with self-employed applicants and companies?',
    faqA3: 'Yes. We evaluate individuals, self-employed applicants and legal entities.',
  ...
  fr: {
    ...
    heroMetric2Value: 'Nationaux et étrangers résidents',
    ...
    testPrevAria: 'Précédent',
    testNextAria: 'Suivant',
    testDotsAria: 'Indicateurs',
    coverageTitle: 'Prêts hypothécaires par province au Costa Rica',
    coverageText:
    ...
    coverageCard3Text: 'Financement garanti par bien immobilier pour liquidité, investissement ou fonds de roulement.',
    coverageCard4Title: 'Prêts hypothécaires à Alajuela',
    coverageCard4Text: 'Formalisation claire pour les propriétés résidentielles et commerciales dans toute la province.',
    coverageCard5Title: 'Prêts hypothécaires à Guanacaste',
    coverageCard5Text: 'Nous traitons des cas hors de la GAM avec évaluation professionnelle et suivi continu.',
    coverageCard6Title: 'Prêts hypothécaires à Puntarenas',
    coverageCard6Text: 'Couverture nationale pour les propriétés inscrites, avec processus légal et transparent.',
    coverageCard7Title: 'Prêts hypothécaires à Limón',
    coverageCard7Text: 'Accompagnement pour les propriétés de la région caraïbe, de l’évaluation à la formalisation.',
    coverageCardCta: 'Demander une évaluation',
    faqTitle: 'Questions fréquentes',
    faqText: 'Réponses directes aux questions les plus courantes avant de demander votre évaluation.',
    faqQ1: 'Quelles sont les conditions pour faire une demande ?',
    faqA1:
      'La condition principale est d’être propriétaire du bien utilisé pour demander le prêt, ainsi que de présenter votre pièce d’identité pour démarrer l’évaluation.',
    faqQ2: 'Puis-je demander un crédit en tant qu’étranger résident ?',
    faqA2: 'Oui. Nous accompagnons des clients de toutes nationalités propriétaires de biens au Costa Rica.',
    faqQ3: 'Travaillez-vous avec des indépendants et des entreprises ?',
    faqA3: 'Oui. Nous évaluons les particuliers, les indépendants et les personnes morales.',
...
function applyTranslations() {
  ...
  if (prevBtn) prevBtn.setAttribute('aria-label', translations[currentLang].testPrevAria || 'Previous');
  if (nextBtn) nextBtn.setAttribute('aria-label', translations[currentLang].testNextAria || 'Next');
  if (dots) dots.setAttribute('aria-label', translations[currentLang].testDotsAria || 'Indicators');
